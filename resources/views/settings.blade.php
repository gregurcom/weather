            ...
            <div class="col-sm-5">
                <form action="{{ route('weather.settings') }}" method="GET">
                    ...
                    <div class="input-group mt-3">
                        ...
                        <select class="p-1 rounded-2" name="speed">
                    ...
                    <div class="input-group mt-3">
                        ...
                        <select class="p-1 rounded-2" name="pressure">
                    ...
                    <div class="input-group mt-3">
                        ...
                        <select class="p-1 rounded-2" name="precipitation">
                    ...
                    <div class="input-group mt-3">
                        ...
                        <select class="p-1 rounded-2" name="language">
